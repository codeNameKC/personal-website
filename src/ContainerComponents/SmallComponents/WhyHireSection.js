    ...
    return (
        ...
        return (
            ...
            <h1 id="WhyHireMe">
                ...
                <p className="textBody" style={{ fontSize: '2em'}}>
                    Mit job er min første prioritet. Jeg ankommer til tiden og gøre mit bedste til at færdiggøre arbejdet til tide,
                     ...
                     Jeg vil med glæde blive en del af et hold. Jeg ser frem til at arbejde for dit firma,
                      hvis du leder efter en passioneret Web Developer der kan hjælpe med at lave få din hjemme side eller mobil app til lifs,
                     med de nyeste web teknologier såsom React.js.
                </p>
